...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            // Repita o mesmo padrão para os outros SalesRecords

            SalesRecord r2 = new SalesRecord
            {
                Date = new DateTime(2018, 09, 4),
                Amount = 7000.0,
                Status = SaleStatus.Billed,
                Seller = s5
            };
